...
export const Calculator = () => {
  ...
  return (
    <div className="min-w-[500px] flex flex-col gap-3 items-center justify-center">
      ...
      <div className="text-white flex flex-col bg-linear-to-r from-gray-600 to-gray-900 border-6 rounded-2xl min-w-[360px] border-black min-h-[450px] p-4 gap-3">
